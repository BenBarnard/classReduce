...
[![Coverage Status](https://img.shields.io/codecov/c/github/BenBarnard/hldr/master.svg)](https://codecov.io/github/BenBarnard/hldr?branch=master)
[![Travis-CI Build Status](https://travis-ci.org/BenBarnard/hldr.svg?branch=master)](https://travis-ci.org/BenBarnard/hldr)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/benbarnard/hldr?branch=master&svg=true)](https://ci.appveyor.com/project/benbarnard/hldr)
